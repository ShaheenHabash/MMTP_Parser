...
namespace MMTP_Parser.Entity.MMTP.DIFF.BusinessData.MessageContent
{
    ...
    public class Message_03 : MessageContents //Length ==>71 , Short description ==> Price
    {
        ...
        public Message_03()
        {
            ...
            xField = new Field("PobjMsgP", FieldType.QtmX, 14, 1, "Price", "", "107", "");
            _ObsFields.Add(xField);

            xField = new Field("PphSeaCotJ", FieldType.QtmX, 14, 15, "Highest trade price of the trading day", "", "108", "");
            _ObsFields.Add(xField);

            xField = new Field("PpbSeaCotJ", FieldType.QtmX, 14, 29, "Lowest trade price of the trading day", "", "107", "");
            _ObsFields.Add(xField);

            xField = new Field("YPMsgP", FieldType.Numerical, 2, 43, "Price type", "", "144", "");
            _ObsFields.Add(xField);

            xField = new Field("IsensVarP", FieldType.Alphanumerical, 1, 45, "Last trade price variation as compared to the reference price", "", "87", "");
            _ObsFields.Add(xField);

            xField = new Field("Filler_1", FieldType.Alphanumerical, 5, 46, "", "", "", "");
            _ObsFields.Add(xField);

            xField = new Field("CSensVarPValPP", FieldType.Numerical, 1, 51, "Trade price versus next to last trade price variation flag", "", "69", "");
            _ObsFields.Add(xField);

            xField = new Field("XQVarPJDrPRf", FieldType.QtmX, 14, 52, "Price Variation As Compared to Reference Price", "", "132", "");
            _ObsFields.Add(xField);
