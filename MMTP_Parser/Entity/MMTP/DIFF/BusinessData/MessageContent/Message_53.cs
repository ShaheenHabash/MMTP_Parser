...
namespace MMTP_Parser.Entity.MMTP.DIFF.BusinessData.MessageContent
{
    ...
    public class Message_53 : MessageContents //Length ==> 1705 , Short description ==> Creation of Instrument Characteristics
    {
        ...
        public Message_53()
        {
            ...
            xField = new Field("Filler_1", FieldType.Numerical, 1, 22, "", "", "", "");
            _ObsFields.Add(xField);
            ...
            xField = new Field("Filler_3", FieldType.Numerical, 66, 90, "", "", "", "");
            _ObsFields.Add(xField);
            ...
            xField = new Field("Filler_4", FieldType.Numerical, 7, 167, "", "", "", "");
            _ObsFields.Add(xField);
            ...
            xField = new Field("Filler_5", FieldType.Numerical, 14, 191, "", "", "", "");
            _ObsFields.Add(xField);
            ...
            xField = new Field("Filler_7", FieldType.Numerical, 6, 238, "", "", "", "");
            _ObsFields.Add(xField);
            ...
            xField = new Field("Filler_9", FieldType.Numerical, 19, 328, "", "", "", "");
            _ObsFields.Add(xField);
