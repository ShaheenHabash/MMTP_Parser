...
namespace MMTP_Parser.Entity.MMTP.DIFF.BusinessData.MessageContent
{
    ...
    public class Message_5F : MessageContents //Length ==> 76 , Short description ==> Sectors
    {
        ...
        public Message_5F()
        {
            ...
            xField = new Field("CSecVal", FieldType.Alphanumerical, 3, 1, "Sector Code", "", "68", "");
            _ObsFields.Add(xField);

            xField = new Field("LsecVal", FieldType.Alphanumerical, 40, 4, "Sector Name", "", "97", "");
            _ObsFields.Add(xField);

            xField = new Field("CSuperSecVal", FieldType.Alphanumerical, 4, 44, "Super Sector Code", "", "71", "");
            _ObsFields.Add(xField);

            xField = new Field("CSecValICB", FieldType.Alphanumerical, 4, 48, "Sector Code ICB", "", "69", "");
            _ObsFields.Add(xField);
