...
namespace MMTP_Parser.Entity.MMTP.DIFF.BusinessData.MessageContent
{
    ...
    public class Message_16 : MessageContents //Length ==>28 , Short description ==> Group State Change
    {
        ...
        public Message_16()
        {
            ...
            xField = new Field("CIdGrc", FieldType.Alphanumerical, 2, 1, "Instrument group identification", "", "113", "");
            _ObsFields.Add(xField);

            xField = new Field("CEtaGrc", FieldType.Alphanumerical, 1, 3, "Instrument group state", "59", "", "");
            _ObsFields.Add(xField);

            xField = new Field("ZPcsNSCEmetMsgRLCGrc", FieldType.Numerical, 2, 4, "Number of Trading Units used by the group", "", "149", "");
            _ObsFields.Add(xField);
