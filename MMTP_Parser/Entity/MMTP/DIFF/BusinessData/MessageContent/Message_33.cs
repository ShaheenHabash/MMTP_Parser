...
namespace MMTP_Parser.Entity.MMTP.DIFF.BusinessData.MessageContent
{
    ...
    public class Message_33 : MessageContents //Length ==>242 , Short description ==> TCS Trade
    {
        ...
        public Message_33()
        {
            ...
            xField = new Field("YMarNSC", FieldType.Alphanumerical, 2, 111, "NSC® market segment", "", "140", "");
            _ObsFields.Add(xField);

            xField = new Field("Filler_5", FieldType.Alphanumerical, 86, 113, "", "", "", "");
            _ObsFields.Add(xField);

            xField = new Field("DHTran", FieldType.Alphanumerical, 14, 199, "Trade Date and Time", "", "75", "");
            _ObsFields.Add(xField);
