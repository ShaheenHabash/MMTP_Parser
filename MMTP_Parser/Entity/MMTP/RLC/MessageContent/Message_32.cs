...
namespace MMTP_Parser.Entity.MMTP.RLC.MessageContent
{
    ...
    public class Message_32 : MessageContents //Length ==>117 , Short description ==> Opening Summary
    {
        ...
        public Message_32()
        {
            ...
            xField = new Field("PPrCJ", FieldType.QtmX, 14, 1, "First trade price of the trading day", "", "141", "");
            _ObsFields.Add(xField);

            xField = new Field("PDrCotJ", FieldType.QtmX, 14, 15, "Last trade price of the trading day", "", "137", "");
            _ObsFields.Add(xField);

            xField = new Field("PphSeaCotJ", FieldType.QtmX, 14, 29, "Highest trade price of the trading day", "", "140", "");
            _ObsFields.Add(xField);

            xField = new Field("PpbSeaCotJ", FieldType.QtmX, 14, 43, "Lowest trade price of the trading day", "", "140", "");
            _ObsFields.Add(xField);

            xField = new Field("YPOvVal", FieldType.Numerical, 2, 57, "Trend flag", "", "178", "");
            _ObsFields.Add(xField);

            xField = new Field("QtitNgOvVal", FieldType.Numerical, 12, 59, "Total traded quantity at opening", "", "152", "");
            _ObsFields.Add(xField);

            xField = new Field("IsensVarP", FieldType.Alphanumerical, 1, 71, "Last trade price variation as compared to the reference price", "", "120", "");
            _ObsFields.Add(xField);

            xField = new Field("Filler", FieldType.Alphanumerical, 5, 72, "", "", "", "");
            _ObsFields.Add(xField);

            xField = new Field("CSensVarPTranPP", FieldType.Alphanumerical, 1, 77, "Sign of price variation as compared to the previous price", "", "101", "");
            _ObsFields.Add(xField);

            xField = new Field("XQVarPJDrPRf", FieldType.QtmX, 14, 78, "Price Variation As Compared to Reference Price", "", "165", "");
            _ObsFields.Add(xField);
