...
namespace MMTP_Parser.Entity.MMTP.RLC.MessageContent
{
    ...
    public class Message_05 : MessageContents //Length ==>48 , Short description ==> Instrument State Change
    {
        ...
        public Message_05()
        {
            ...
            xField = new Field("IetaCotVal", FieldType.Alphanumerical, 1, 1, "Instrument trading state indicator", "", "115", "");
            _ObsFields.Add(xField);

            xField = new Field("IOrgResVal", FieldType.Alphanumerical, 1, 2, "Indicator giving origin of instrument reservation", "", "119", "");
            _ObsFields.Add(xField);

            xField = new Field("DDebSuVal", FieldType.Numerical, 8, 3, "Start date for suspension of instrument", "", "105", "");
            _ObsFields.Add(xField);

            xField = new Field("HdebSuVal", FieldType.Numerical, 6, 11, "Start time for suspension of instrument", "", "109", "");
            _ObsFields.Add(xField);

            xField = new Field("CEtaVal", FieldType.Alphanumerical, 2, 17, "Code indicating the state of the instrument in NSC®", "", "89", "");
            _ObsFields.Add(xField);

            xField = new Field("CActModEtaVal", FieldType.Alphanumerical, 1, 19, "Action code for the instrument state change", "", "86", "");
            _ObsFields.Add(xField);

            xField = new Field("HOvPgmVal", FieldType.Alphanumerical, 6, 20, "Programmed opening time for instrument", "", "112", "");
            _ObsFields.Add(xField);

            xField = new Field("CEtaValSysTCS", FieldType.Alphanumerical, 1, 26, "Instrument state code in TCS system", "", "90", "");
            _ObsFields.Add(xField);
