...
namespace MMTP_Parser.Entity.MMTP.RLC.MessageContent
{
    ...
    public class Message_30 : MessageContents //Length ==>117 , Short description ==> Theoretical Opening Price
    {
        ...
        public Message_30()
        {
            ...
            xField = new Field("PTeoOvJ", FieldType.QtmX, 14, 1, "Theoretical Opening Price", "", "142", "");
            _ObsFields.Add(xField);

            xField = new Field("QXtePTeoOvj", FieldType.Numerical, 12, 15, "Total traded quantity at pening", "", "153", "");
            _ObsFields.Add(xField);

            xField = new Field("IsensVarP", FieldType.Alphanumerical, 1, 27, "Last trade price variation as compared to the reference price", "", "120", "");
            _ObsFields.Add(xField);

            xField = new Field("Filler_1", FieldType.Alphanumerical, 5, 28, "", "", "", "");
            _ObsFields.Add(xField);

            xField = new Field("CSensQNrepOv", FieldType.Alphanumerical, 1, 33, "Unfilled quantity side at opening price", "", "101", "");
            _ObsFields.Add(xField);

            xField = new Field("QnrepOv", FieldType.Numerical, 12, 34, "Unfilled quantity at opening", "", "148", "");
            _ObsFields.Add(xField);

            xField = new Field("QTitMeLimSimAc", FieldType.Numerical, 12, 46, "Total simulated buy quantity", "", "150", "");
            _ObsFields.Add(xField);

            xField = new Field("PmeLimSimAcVal", FieldType.QtmX, 14, 58, "Simulated buy price", "", "139", "");
            _ObsFields.Add(xField);

            xField = new Field("PmeLimSimVtVal", FieldType.QtmX, 14, 72, "Simulated sell price", "", "139", "");
            _ObsFields.Add(xField);

            xField = new Field("QTitMeLimSimVt", FieldType.Numerical, 12, 86, "Total simulated sell quantity", "", "151", "");
            _ObsFields.Add(xField);

            xField = new Field("XQVarPJDrPRf", FieldType.QtmX, 14, 98, "Price Variation As Compared to Reference Price", "", "165   ", "");
            _ObsFields.Add(xField);
