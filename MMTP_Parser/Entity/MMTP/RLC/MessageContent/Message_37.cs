...
namespace MMTP_Parser.Entity.MMTP.RLC.MessageContent
{
    ...
    public class Message_37 : MessageContents //Length ==> 48 , Short description ==> Static Thresholds
    {
        ...
        public Message_37()
        {
            ...
            xField = new Field("PSGelStaMax", FieldType.QtmX, 14, 1, "Upper static threshold of freezing", "", "142", "");
            _ObsFields.Add(xField);

            xField = new Field("PSGelStaMin", FieldType.QtmX, 14, 15, "Lower static threshold of freezing", "", "142", "");
            _ObsFields.Add(xField);
