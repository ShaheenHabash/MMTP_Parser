...
namespace MMTP_Parser.Entity.MMTP.RLC.MessageContent
{
    ...
    public class Message_23 : MessageContents //Length ==>947 , Short description ==> Text Message
    {
        ...
        public Message_23()
        {
            ...
            xField = new Field("YMarMsg", FieldType.Alphanumerical, 2, 1, "Type of Market concerned by the message", "", "173", "");
            _ObsFields.Add(xField);

            xField = new Field("IUrg", FieldType.Alphanumerical, 1, 3, "Priority Indicator", "", "124", "");
            _ObsFields.Add(xField);

            xField = new Field("YCrl", FieldType.Alphanumerical, 1, 4, "Nature of Message", "", "171", "");
            _ObsFields.Add(xField);

            xField = new Field("YDest", FieldType.Alphanumerical, 2, 5, "Address Type", "", "171", "");
            _ObsFields.Add(xField);

            xField = new Field("CIdMsg", FieldType.Alphanumerical, 3, 7, "Message Number", "", "94", "");
            _ObsFields.Add(xField);

            xField = new Field("ZTotSeg", FieldType.Alphanumerical, 2, 10, "Number of messages in this message", "", "181", "");
            _ObsFields.Add(xField);

            xField = new Field("NSeqSeq", FieldType.Alphanumerical, 1, 12, "Sequence number of message within this message", "", "132", "");
            _ObsFields.Add(xField);

            xField = new Field("LTit", FieldType.Alphanumerical, 80, 14, "Message title", "", "129", "");
            _ObsFields.Add(xField);

            xField = new Field("LMsg", FieldType.Alphanumerical, 854, 94, "Message text", "", "128", "");
            _ObsFields.Add(xField);
        }
    }
}
