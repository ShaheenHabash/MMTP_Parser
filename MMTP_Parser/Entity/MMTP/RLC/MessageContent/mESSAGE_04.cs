...
namespace MMTP_Parser.Entity.MMTP.RLC.MessageContent
{
    ...
    public class Message_04 : MessageContents //Length ==>75-385 , Short description ==> Best Limits
    {
        ...
        public Message_04()
        {
            ...
            xField = new Field("YOmOrgTran", FieldType.Alphanumerical, 1, 1, "Type of orders at the origin of a trade", "", "175", "");
            ...
            //Occ. 6
            xField = new Field("ItabModMeLim_1", FieldType.Alphanumerical, 1, 8, "Change of best limit flag", "", "123", "6");
            _ObsFields.Add(xField);


            xField = new Field("ItabModMeLim_2", FieldType.Alphanumerical, 1, 9, "Change of best limit flag", "", "123", "6");
            _ObsFields.Add(xField);


            xField = new Field("ItabModMeLim_3", FieldType.Alphanumerical, 1, 10, "Change of best limit flag", "", "123", "6");
            _ObsFields.Add(xField);


            xField = new Field("ItabModMeLim_4", FieldType.Alphanumerical, 1, 11, "Change of best limit flag", "", "123", "6");
            _ObsFields.Add(xField);


            xField = new Field("ItabModMeLim_5", FieldType.Alphanumerical, 1, 12, "Change of best limit flag", "", "123", "6");
            _ObsFields.Add(xField);


            xField = new Field("ItabModMeLim_6", FieldType.Alphanumerical, 1, 13, "Change of best limit flag", "", "123", "6");
            _ObsFields.Add(xField);

            //AMeLim ==> Best limit aggregate ,Occ. 6
            xField = new Field("QTitMeDem_1", FieldType.Numerical, 12, 14, "Best buy limit quantity", "", "150", "");
            _ObsFields.Add(xField);

            xField = new Field("ZOrdMeDem_1", FieldType.Numerical, 4, 26, "Number of orders at a best buy limit", "", "183", "");
            _ObsFields.Add(xField);

            xField = new Field("PmeDem_1", FieldType.QtmX, 14, 30, "Best buy limit price", "", "138", "");
            _ObsFields.Add(xField);

            xField = new Field("PmeOf_1", FieldType.QtmX, 14, 44, "Best sell limit price", "", "139", "");
            _ObsFields.Add(xField);

            xField = new Field("ZOrdMeOf_1", FieldType.Numerical, 4, 58, "Number of orders at a best sell limit", "", "183", "");
            _ObsFields.Add(xField);

            xField = new Field("QTitMeOf_1", FieldType.Numerical, 12, 62, "Best sell limit quantity", "", "151", "");
            _ObsFields.Add(xField);

            xField = new Field("Filler_2", FieldType.Alphanumerical, 2, 74, "", "", "", "");
            _ObsFields.Add(xField);

            xField = new Field("QTitMeDem_2", FieldType.Numerical, 12, 76, "Best buy limit quantity", "", "150", "");
            _ObsFields.Add(xField);

            xField = new Field("ZOrdMeDem_2", FieldType.Numerical, 4, 88, "Number of orders at a best buy limit", "", "183", "");
            _ObsFields.Add(xField);

            xField = new Field("PmeDem_2", FieldType.QtmX, 14, 92, "Best buy limit price", "", "138", "");
            _ObsFields.Add(xField);

            xField = new Field("PmeOf_2", FieldType.QtmX, 14, 106, "Best sell limit price", "", "139", "");
            _ObsFields.Add(xField);

            xField = new Field("ZOrdMeOf_2", FieldType.Numerical, 4, 120, "Number of orders at a best sell limit", "", "183", "");
            _ObsFields.Add(xField);

            xField = new Field("QTitMeOf_2", FieldType.Numerical, 12, 124, "Best sell limit quantity", "", "151", "");
            _ObsFields.Add(xField);

            xField = new Field("Filler_3", FieldType.Alphanumerical, 2, 136, "", "", "", "");
            _ObsFields.Add(xField);

            xField = new Field("QTitMeDem_3", FieldType.Numerical, 12, 138, "Best buy limit quantity", "", "150", "");
            _ObsFields.Add(xField);

            xField = new Field("ZOrdMeDem_3", FieldType.Numerical, 4, 150, "Number of orders at a best buy limit", "", "183", "");
            _ObsFields.Add(xField);

            xField = new Field("PmeDem_3", FieldType.QtmX, 14, 154, "Best buy limit price", "", "138", "");
            _ObsFields.Add(xField);

            xField = new Field("PmeOf_3", FieldType.QtmX, 14, 168, "Best sell limit price", "", "139", "");
            _ObsFields.Add(xField);

            xField = new Field("ZOrdMeOf_3", FieldType.Numerical, 4, 182, "Number of orders at a best sell limit", "", "183", "");
            _ObsFields.Add(xField);

            xField = new Field("QTitMeOf_3", FieldType.Numerical, 12, 182, "Best sell limit quantity", "", "151", "");
            _ObsFields.Add(xField);

            xField = new Field("Filler_4", FieldType.Alphanumerical, 2, 198, "", "", "", "");
            _ObsFields.Add(xField);

            xField = new Field("QTitMeDem_4", FieldType.Numerical, 12, 200, "Best buy limit quantity", "", "150", "");
            _ObsFields.Add(xField);

            xField = new Field("ZOrdMeDem_4", FieldType.Numerical, 4, 212, "Number of orders at a best buy limit", "", "183", "");
            _ObsFields.Add(xField);

            xField = new Field("PmeDem_4", FieldType.QtmX, 14, 216, "Best buy limit price", "", "138", "");
            _ObsFields.Add(xField);

            xField = new Field("PmeOf_4", FieldType.QtmX, 14, 230, "Best sell limit price", "", "139", "");
            _ObsFields.Add(xField);

            xField = new Field("ZOrdMeOf_4", FieldType.Numerical, 4, 244, "Number of orders at a best sell limit", "", "183", "");
            _ObsFields.Add(xField);

            xField = new Field("QTitMeOf_4", FieldType.Numerical, 12, 248, "Best sell limit quantity", "", "151", "");
            _ObsFields.Add(xField);

            xField = new Field("Filler_5", FieldType.Alphanumerical, 2, 260, "", "", "", "");
            _ObsFields.Add(xField);

            xField = new Field("QTitMeDem_5", FieldType.Numerical, 12, 262, "Best buy limit quantity", "", "150", "");
            _ObsFields.Add(xField);

            xField = new Field("ZOrdMeDem_5", FieldType.Numerical, 4, 274, "Number of orders at a best buy limit", "", "183", "");
            _ObsFields.Add(xField);

            xField = new Field("PmeDem_5", FieldType.QtmX, 14, 278, "Best buy limit price", "", "138", "");
            _ObsFields.Add(xField);

            xField = new Field("PmeOf_5", FieldType.QtmX, 14, 292, "Best sell limit price", "", "139", "");
            _ObsFields.Add(xField);

            xField = new Field("ZOrdMeOf_5", FieldType.Numerical, 4, 306, "Number of orders at a best sell limit", "", "183", "");
            _ObsFields.Add(xField);

            xField = new Field("QTitMeOf_5", FieldType.Numerical, 12, 314, "Best sell limit quantity", "", "151", "");
            _ObsFields.Add(xField);

            xField = new Field("Filler_6", FieldType.Alphanumerical, 2, 322, "", "", "", "");
            _ObsFields.Add(xField);

            xField = new Field("QTitMeDem_6", FieldType.Numerical, 12, 324, "Best buy limit quantity", "", "150", "");
            _ObsFields.Add(xField);

            xField = new Field("ZOrdMeDem_6", FieldType.Numerical, 4, 336, "Number of orders at a best buy limit", "", "183", "");
            _ObsFields.Add(xField);

            xField = new Field("PmeDem_6", FieldType.QtmX, 14, 340, "Best buy limit price", "", "138", "");
            _ObsFields.Add(xField);

            xField = new Field("PmeOf_6", FieldType.QtmX, 14, 354, "Best sell limit price", "", "139", "");
            _ObsFields.Add(xField);

            xField = new Field("ZOrdMeOf_6", FieldType.Numerical, 4, 368, "Number of orders at a best sell limit", "", "183", "");
            _ObsFields.Add(xField);

            xField = new Field("QTitMeOf_6", FieldType.Numerical, 12, 372, "Best sell limit quantity", "", "151", "");
            _ObsFields.Add(xField);
