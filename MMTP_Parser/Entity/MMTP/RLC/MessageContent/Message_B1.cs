...
namespace MMTP_Parser.Entity.MMTP.RLC.MessageContent
{
    ...
    public class Message_B1 : MessageContents //Length ==> 148 , Short description ==> Real-time Date for an Index
    {
        ...
        public Message_B1()
        {
            ...
            xField = new Field("CNivIdx", FieldType.Alphanumerical, 1, 1, "Index level code", "", "97", "");
            _ObsFields.Add(xField);

            xField = new Field("XDrNivJIdx", FieldType.Numerical, 6, 2, "Day's last index level", "", "156", "");
            _ObsFields.Add(xField);

            xField = new Field("XPhNivJIdx", FieldType.Numerical, 6, 8, "Day's highest index level", "", "164", "");
            _ObsFields.Add(xField);

            xField = new Field("HphJIdx", FieldType.Numerical, 6, 14, "Time of day's highest index level", "", "112", "");
            _ObsFields.Add(xField);

            xField = new Field("XPbNivJIdx", FieldType.Numerical, 6, 20, "Day's lowest index level", "", "164", "");
            _ObsFields.Add(xField);

            xField = new Field("HPbJIdx", FieldType.Numerical, 6, 26, "Time of day's lowest index level", "", "112", "");
            _ObsFields.Add(xField);

            xField = new Field("ZValIdxCot", FieldType.Numerical, 3, 32, "Number of traded instruments in the index", "", "186", "");
            _ObsFields.Add(xField);

            xField = new Field("XCapValAcfIdx", FieldType.Numerical, 5, 35, "Percentage of capitalization for the active instruments in the index", "", "155", "");
            _ObsFields.Add(xField);

            xField = new Field("IsensXVarIdxJ", FieldType.Alphanumerical, 1, 40, "Sign of Variation for Day's Index ('Forerunner”)", "", "121", "");
            _ObsFields.Add(xField);

            xField = new Field("XVarIdxJ", FieldType.Numerical, 5, 41, "Variation for Day's Index ('Forerunner”)", "", "167", "");
            _ObsFields.Add(xField);

            xField = new Field("IsensXVarIdxJRfV", FieldType.Alphanumerical, 1, 46, "Sign of Variation for Day's Index / Previous Day's Reference", "", "122", "");
            _ObsFields.Add(xField);

            xField = new Field("XVarIdxJRfV", FieldType.Numerical, 5, 47, "Variation for Day's Index / Previous Day's Reference", "", "167", "");
            _ObsFields.Add(xField);

            xField = new Field("Filler_1", FieldType.Alphanumerical, 6, 52, "", "", "", "");
            _ObsFields.Add(xField);

            xField = new Field("IsensXVarIdxJDrAnP", FieldType.Alphanumerical, 1, 58, "Sign of Variation for Day's / Last for Previous Year", "", "121", "");
            _ObsFields.Add(xField);

            xField = new Field("XVarIdxJDrAnP", FieldType.Numerical, 5, 59, "Variation for Day's Index / Last for Previous Year", "", "168", "");
            _ObsFields.Add(xField);

            xField = new Field("XNivIrteNetIbs", FieldType.QtmX, 7, 64, "Net Return Index Level", "", "163", "");
            _ObsFields.Add(xField);

            xField = new Field("XNivIrteGlIbs", FieldType.QtmX, 7, 71, "Gross Return Index Level", "", "162", "");
            _ObsFields.Add(xField);

            xField = new Field("ZValBaiIbs", FieldType.Numerical, 3, 78, "Number of declining instruments in the index", "", "185", "");
            _ObsFields.Add(xField);

            xField = new Field("ZValHauIbs", FieldType.Numerical, 3, 81, "Number of rising instruments in the index", "", "185", "");
            _ObsFields.Add(xField);

            xField = new Field("ZValIchgIbs", FieldType.Numerical, 3, 84, "Number of unchanged instruments in the index", "", "186", "");
            _ObsFields.Add(xField);

            xField = new Field("ZValNonCotIbs", FieldType.Numerical, 3, 87, "Number of non-traded instruments in the index", "", "186", "");
            _ObsFields.Add(xField);

            xField = new Field("ZValResIbs", FieldType.Numerical, 3, 90, "Number of reserved instruments in the index", "", "187", "");
            _ObsFields.Add(xField);

            xField = new Field("ZValSuIbs", FieldType.Numerical, 3, 93, "Number of suspended instruments in the index", "", "187", "");
            _ObsFields.Add(xField);

            xField = new Field("ZTotValIbs", FieldType.Numerical, 3, 96, "Total number of instruments in the index", "", "185", "");
            _ObsFields.Add(xField);

            xField = new Field("IsensXMoyVarValIbs", FieldType.Alphanumerical, 1, 99, "Sign of Average Variation for Instruments in the Index", "", "121", "");
            _ObsFields.Add(xField);

            xField = new Field("XMoyVarValIbs", FieldType.Numerical, 6, 100, "Average Variation for Instruments in the Index", "", "159", "");
            _ObsFields.Add(xField);

            xField = new Field("XMoyVarValBaiIbs", FieldType.Numerical, 6, 106, "Average Variation for Declining Instruments in the Index", "", "159", "");
            _ObsFields.Add(xField);

            xField = new Field("XMoyVarValHauIbs", FieldType.Numerical, 6, 112, "Average Variation for Rising Instruments in the Index", "", "118", "");
            _ObsFields.Add(xField);

            xField = new Field("IIBsAscNivIbs", FieldType.Alphanumerical, 1, 118, "Flag for Indicators Related to an Index Level", "", "85", "");
            _ObsFields.Add(xField);

            //**ANivIdxJ ==> Aggregate of Index Levels for the Day (Ift/QMt Format) , Page ==> 85
            xField = new Field("XDrNivJIdx_IftQMt", FieldType.QtmX, 10, 119, "Day's last index level", "", "156", "");
            _ObsFields.Add(xField);

            xField = new Field("XPhNivJIdx_IftQMt", FieldType.QtmX, 10, 129, "Day's highest index level", "", "164", "");
            _ObsFields.Add(xField);

            xField = new Field("XPbNivJIdx_IftQMt", FieldType.QtmX, 10, 139, "Day's lowest index level", "", "164", "");
            _ObsFields.Add(xField);
            //##ANivIdxJ ==> Aggregate of Index Levels for the Day (Ift/QMt Format) , Page ==> 85
        }
    }
